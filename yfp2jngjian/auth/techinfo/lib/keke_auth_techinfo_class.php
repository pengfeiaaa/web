<?php
keke_lang_class::load_lang_class('keke_auth_techinfo_class');
class keke_auth_techinfo_class extends keke_auth_base_class{
    public static function get_instance($code='techinfo') {
        static $obj = null;
        if ($obj == null) {
            $obj = new keke_auth_techinfo_class($code);
        }
        return $obj;
    }
    public function __construct($code='techinfo') {
        parent::__construct($code);
        $this->_primary_key     ='techinfo_a_id';
